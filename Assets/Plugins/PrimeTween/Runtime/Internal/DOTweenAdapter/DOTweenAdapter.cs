...
namespace PrimeTween {
    ...
    public partial struct Tween {
        ...
        static TypeUnion CalculateRelative(ReusableTween tween, TypeUnion current, TypeUnion diff) {
        ...
        Tween setFrom(bool setImmediately, bool isRelative, TypeUnion? fromValue = null, PropType propType = PropType.None) {
            if (!tryManipulate()) {
                return this;
            }
